...
module.exports = (grunt) => {
  ...
  grunt.initConfig({
    ...
    concat: {
      license: {
        ...
        files: {
          'dist/gridics-editor-code-challenge/plugin.js': [
            'src/text/license-header.js',
            scratchPluginMinPath
          ],
          'dist/gridics-editor-code-challenge/plugin.min.js': [
            'src/text/license-header.js',
            scratchPluginMinPath
          ]
        }
    ...
    copy: {
      css: {
        files: [
          { src: [ 'CHANGELOG.txt', 'LICENSE.txt' ], dest: 'dist/gridics-editor-code-challenge', expand: true }
        ]
      }
    },
  ...
  grunt.registerTask('version', 'Creates a version file', () => {
    grunt.file.write('dist/gridics-editor-code-challenge/version.txt', BUILD_VERSION);
  });
